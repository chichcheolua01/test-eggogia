<?php
    ...
    //     $search = $_GET["search"];
    //     $search_query = "SELECT * FROM categories WHERE categoryName like '%$search%'";
    //     if (isset($_GET["search"])){
    //         $categories = getAll($search_query);
    //     }
    //     else {
                ...
                <table class="w-full">
                    ...
                    <tbody>
                            ...
                            <?php foreach($categories as $key => $value): ?>
                                <tr class="grid grid-cols-3 <?php if($value['id'] == 4){echo "hidden";}?>">
