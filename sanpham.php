    ...
    <div class="grid grid-cols-8 relative">
        <div id="manager_menu" class="bg-[#4A4A4A] h-[1363px] absolute duration-500 hidden md:block">
            ...
            <div class="py-8 px-[18px] flex flex-col space-y-4">
                <a href="index.php"><button class="p-[12.5px] flex items-center justify-center lg:justify-start lg:space-x-[10.5px] bg-white w-full rounded-lg iii"> <img src="image/dashboard-button.png" alt="">
                        <p class="hidden lg:block ">Trang chủ</p>
                    </button></a>
            ...
            <div class="p-[36px]">
                <div class="relative">
                    ...
                    <div class="absolute inset-x-0 top-1/2 flex justify-center">
                        <h1 class="sm:text-xl md:text-2xl lg:text-4xl duration-500 text-white font-bold">Quản lý sản phẩm</h1>
                    </div>
                </div>
            </div>
