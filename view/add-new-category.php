        ...
        <div class="col-span-8 md:pl-[101px] lg:pl-[218.95px]">
            ...
            <div class="p-[36px] flex justify-center">
                <div class="flex flex-col w-2/3">
                    <h1 class="text-center text-4xl pb-5">Thêm mới danh mục</h1>
                    <form class="flex flex-col justify-center items-center space-y-4" action="../controller/save-add-category.php" method="POST" enctype="multipart/form-data">
                        <div class="mt-[32.5px] w-full space-y-2">
                            <p class="py-2">Tên danh mục</p>
                            <input require class="border border-gray-300 px-[12px] py-[6px] w-full rounded-md" type="text" name="categoryName" placeholder="Nhập tên danh mục" value="">
                        </div>
                        <div class="flex justify-center pt-5"><button class="bg-[#38A169] text-white rounded p-[10px] " type="submit">Add New Category</button></div>
                    </form>
                </div>
            </div>
        </div>
